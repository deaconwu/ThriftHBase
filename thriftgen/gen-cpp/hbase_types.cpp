...
int _kTCompareOperatorValues[] = {
  TCompareOperator::LESS,
  TCompareOperator::LESS_OR_EQUAL,
  TCompareOperator::EQUAL,
  TCompareOperator::NOT_EQUAL,
  TCompareOperator::GREATER_OR_EQUAL,
  TCompareOperator::GREATER,
  TCompareOperator::NO_OP
};
const char* _kTCompareOperatorNames[] = {
  "LESS",
  "LESS_OR_EQUAL",
  "EQUAL",
  "NOT_EQUAL",
...
const std::map<int, const char*> _TCompareOperator_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(7, _kTCompareOperatorValues, _kTCompareOperatorNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));

std::ostream& operator<<(std::ostream& out, const TCompareOperator::type& val) {
  std::map<int, const char*>::const_iterator it = _TCompareOperator_VALUES_TO_NAMES.find(val);
  if (it != _TCompareOperator_VALUES_TO_NAMES.end()) {
    out << it->second;
  } else {
    out << static_cast<int>(val);
  }
...
std::string to_string(const TCompareOperator::type& val) {
  std::map<int, const char*>::const_iterator it = _TCompareOperator_VALUES_TO_NAMES.find(val);
  if (it != _TCompareOperator_VALUES_TO_NAMES.end()) {
    return std::string(it->second);
  } else {
