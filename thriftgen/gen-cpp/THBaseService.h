...
class THBaseServiceIf {
 public:
   ...
   */
  virtual bool checkAndMutate(const std::string& table, const std::string& row, const std::string& family, const std::string& qualifier, const TCompareOperator::type compareOperator, const std::string& value, const TRowMutations& rowMutations) = 0;
...
class THBaseServiceNull : virtual public THBaseServiceIf {
 public:
  ...
  bool checkAndMutate(const std::string& /* table */, const std::string& /* row */, const std::string& /* family */, const std::string& /* qualifier */, const TCompareOperator::type /* compareOperator */, const std::string& /* value */, const TRowMutations& /* rowMutations */) {
    bool _return = false;
    return _return;
  }
...
class THBaseService_checkAndMutate_args {
 public:
  ...
  THBaseService_checkAndMutate_args() : table(), row(), family(), qualifier(), compareOperator((TCompareOperator::type)0), value() {
  }
  ...
  std::string family;
  std::string qualifier;
  TCompareOperator::type compareOperator;
  std::string value;
  ...
  void __set_compareOperator(const TCompareOperator::type val);
  ...
  bool operator == (const THBaseService_checkAndMutate_args & rhs) const
  {
    ...
    if (!(qualifier == rhs.qualifier))
      return false;
    if (!(compareOperator == rhs.compareOperator))
      return false;
    if (!(value == rhs.value))
      return false;
...
class THBaseService_checkAndMutate_pargs {
 public:
  ...
  const std::string* family;
  const std::string* qualifier;
  const TCompareOperator::type* compareOperator;
  const std::string* value;
...
class THBaseServiceClient : virtual public THBaseServiceIf {
 ...
 public:
  ...
  bool checkAndMutate(const std::string& table, const std::string& row, const std::string& family, const std::string& qualifier, const TCompareOperator::type compareOperator, const std::string& value, const TRowMutations& rowMutations);
  void send_checkAndMutate(const std::string& table, const std::string& row, const std::string& family, const std::string& qualifier, const TCompareOperator::type compareOperator, const std::string& value, const TRowMutations& rowMutations);
...
class THBaseServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  THBaseServiceProcessorFactory(const ::std::shared_ptr< THBaseServiceIfFactory >& handlerFactory) :
...
class THBaseServiceMultiface : virtual public THBaseServiceIf {
 ...
 public:
  ...
  bool checkAndMutate(const std::string& table, const std::string& row, const std::string& family, const std::string& qualifier, const TCompareOperator::type compareOperator, const std::string& value, const TRowMutations& rowMutations) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->checkAndMutate(table, row, family, qualifier, compareOperator, value, rowMutations);
    }
    return ifaces_[i]->checkAndMutate(table, row, family, qualifier, compareOperator, value, rowMutations);
  }
  ...
  THBaseServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  bool checkAndMutate(const std::string& table, const std::string& row, const std::string& family, const std::string& qualifier, const TCompareOperator::type compareOperator, const std::string& value, const TRowMutations& rowMutations);
  int32_t send_checkAndMutate(const std::string& table, const std::string& row, const std::string& family, const std::string& qualifier, const TCompareOperator::type compareOperator, const std::string& value, const TRowMutations& rowMutations);
